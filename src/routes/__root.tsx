...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Loot gives you a clear view of your income, expenses, plans, and what you can afford." },
      { name: "theme-color", content: "#0F0A0A" },
      { property: "og:title", content: "Loot — Know your loot." },
      { property: "og:description", content: "Know what comes in, what goes out, and what you can afford." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:title", content: "Loot — Know your loot." },
      { name: "twitter:description", content: "Know what comes in, what goes out, and what you can afford." },
    ],
    links: [
